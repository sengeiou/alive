package com.alive.ruo.microservice.commons.core.generator;

import com.google.common.base.Joiner;
import com.alive.ruo.microservice.commons.core.utils.DateUtil;
...
/**
 * @author Somnus
 * @packageName com.alive.ruo.microservice.commons.core.generator
...
public class SnowflakeIdGenerator implements IdGenerator{
    ...
    private volatile Map<String, SnowflakeIdProcessor> idGeneratorMap = new ConcurrentHashMap<>();
