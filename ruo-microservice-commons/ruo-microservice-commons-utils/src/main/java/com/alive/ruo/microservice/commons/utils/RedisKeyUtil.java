...
public class RedisKeyUtil {
	...
	private static final String SEND_SMS_CODE = "wt:sms:code";
	private static final String SEND_EMAIL_CODE = "wt:email:code";
	 ...
	 * @return the send sms rate key
	 */
	public static String getSendSmsCodeKey(String mobile) {
		Preconditions.checkArgument(StringUtils.isNotEmpty(mobile), "参数不能为空");
		return SEND_SMS_CODE + ":" + mobile;
